...
cat return_semantic_query1.json | ./scripts/solr2trec.py > results_semantic_query1_trec.txt
cat return_semantic_query2.json | ./scripts/solr2trec.py > results_semantic_query2_trec.txt
cat return_semantic_query3.json | ./scripts/solr2trec.py > results_semantic_query3_trec.txt
...
echo " --- Evaluating for Semantic Query 1 --- "
src/trec_eval/trec_eval qrels1_trec.txt results_semantic_query1_trec.txt > eval_semantic_query1.txt

echo " --- Evaluating for Semantic Query 2 --- "
src/trec_eval/trec_eval qrels2_trec.txt results_semantic_query2_trec.txt > eval_semantic_query2.txt

echo " --- Evaluating for Semantic Query 3 --- "
src/trec_eval/trec_eval qrels3_trec.txt results_semantic_query3_trec.txt > eval_semantic_query3.txt
...
cat results_semantic_query1_trec.txt | ./scripts/plot_pr.py --qrels qrels1_trec.txt --output prec_rec_semantic_query1.png
cat results_semantic_query2_trec.txt | ./scripts/plot_pr.py --qrels qrels2_trec.txt --output prec_rec_semantic_query2.png
cat results_semantic_query3_trec.txt | ./scripts/plot_pr.py --qrels qrels3_trec.txt --output prec_rec_semantic_query3.png

rm qrels1_trec.txt qrels2_trec.txt qrels3_trec.txt
rm results_query1_trec.txt results_query2_trec.txt results_query3_trec.txt results_semantic_query1_trec.txt results_semantic_query2_trec.txt results_semantic_query3_trec.txt
